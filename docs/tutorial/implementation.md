...
const vc = await api.getVCs({querry: {issuer: {id: 'did:ethr:0x04:0x123..'}, credentialSubject: {id: 'did:ethr:0x04:0x321...'}, credentialSchema: {id: 'https://beta.api.schemas.serto.id/...'}}});
console.log("VC", vc);
//If vc is correct
const vc_id = vc.key;
```
